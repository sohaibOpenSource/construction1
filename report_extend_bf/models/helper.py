...
def extra_global_vals(env):
    ...
    return {
        ...
        'company_display_address': format_multiline_value(company.partner_id.display_address),
        'company_name': company.name,
        'company_footer_line': format_multiline_value(company.footer_line),
        'company_footer_line_break': format_multiline_value(company.footer_line_break),
        'company_footer_line_icon': format_multiline_value(company.footer_line_icon),
        'company_footer_line_break_icon': format_multiline_value(company.footer_line_break_icon),
        'company_header': format_multiline_value(company.report_header),
        'company_footer': format_multiline_value(company.report_footer),
        # Icons
