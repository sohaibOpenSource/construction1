...
class ReportExcelFields(models.Model):
    ...
    aggregate_ids = fields.Many2many('report.excel.aggregate', string='Aggregates', compute='_compute_aggregate_ids')
...
\u0023   result = cell(H7) ''',
    ...
    locked_canvases_bool = fields.Boolean(string='Locked Canvases', default=False, help='''Check the box if the field value is an Locked_Canvases.\n
    ''')
    description = fields.Text('Description')
